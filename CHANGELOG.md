...
- 远程矩阵修复：干净 CI Runner 允许 setup-uv 下载指定 Python；Skill ZIP 条目和 manifest 在 Windows/macOS/Linux 统一使用 POSIX `/` 分隔符。修复后 18/18 个 GitHub Actions 任务通过，`v0.3.0-rc.1` 已发布为 Pre-release。
